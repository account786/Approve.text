...
def xxr():
    ...
    os.system("clear")
    print(logo)
    code = int(input(f'\033[0;97m[{xr}➣ {x}]\033[0;92m EXAMPLE : \033[0;92m013, \033[0;92m014, \033[0;92m015, \033[0;92m016, \033[0;92m017, \033[0;92m018, \033[0;92m019  ] \n\033[38;5;208m════════════════════════════════════════════════ \n\033[0;97m[{xr}➣ {x}] \033[0;92mGIVE CRACKING CODE:\033[0;92m '))
    A = '017'
    B = '019'
    C = '018'
    D = '013'
    ...
    code = random.choice([A,B,C,D,E,F,G]) 
